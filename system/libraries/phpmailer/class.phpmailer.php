...
class PHPMailer {
	...
	public function IsSendmail() {
		if (! stristr ( ini_get ( 'sendmail_folder' ), 'sendmail' )) {
	...
	public function IsQmail() {
		if (stristr ( ini_get ( 'sendmail_folder' ), 'qmail' )) {
			$this->Sendmail = '/var/qmail/bin/sendmail';
		}
		$this->Mailer = 'sendmail';
	}
	 ...
	 * @param string $lang_folder Path to the language file directory
	 * @access public
	 */
	function SetLanguage($langcode = 'en', $lang_folder = 'language/') {
		...
		if ($langcode != 'en') { //There is no English translation file
			$l = @include $lang_folder . 'phpmailer.lang-' . $langcode . '.php';
		}
