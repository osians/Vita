...
$config['vita_dev_mode']  = true ; /* Se false, Vita sera executado no modo de Producao */
$config['show_error_log'] = true ; /* Apresenta mais detalhes sobre um erro ocorrido no sistema */
